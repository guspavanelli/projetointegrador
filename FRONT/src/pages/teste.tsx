...
const questions = [
          ...
          question: (
            <>
              <ul>
                ...
                <li><svg className='arrow' viewBox="0 0 24 24"><path d="M7 4l6 6-6 6V4z" fill="red"/></svg> Ou não realizou qualquer procedimento endoscópico nos últimos 6 meses?</li>
              </ul>
            </>
          ),
          options: ["Sim", "Não"],
        },
        {
          question: (
            <>
              <ul>
                <li><svg className='arrow' viewBox="0 0 24 24"><path d="M7 4l6 6-6 6V4z" fill="red"/></svg> Confirma que não esteve resfriado, fez extração de dente ou tratamento de canal? </li>
                <li><svg className='arrow' viewBox="0 0 24 24"><path d="M7 4l6 6-6 6V4z" fill="red"/></svg> Confirma que não tomou vacina contra COVID-19 e/ou teve diagnóstico positivo ou suspeita (sintomático ou assintomático) nos últimos 7 dias?</li>
              </ul>
            </>
          ),
          options: ["Sim", "Não"],
        },
        {
          question: (
            <>
              <ul>
                <li><svg className='arrow' viewBox="0 0 24 24"><path d="M7 4l6 6-6 6V4z" fill="red"/></svg> Você confirma que não esteve grávida nos últimos 12 meses e não está amamentando atualmente?</li> 
                <li><svg className='arrow' viewBox="0 0 24 24"><path d="M7 4l6 6-6 6V4z" fill="red"/></svg> Confirma que não fez nenhum parto nos últimos 90 dias (parto normal) ou 180 dias (parto cesariana)?</li>
              </ul>
            </>
          ),
          options: ["Sim", "Não"],
